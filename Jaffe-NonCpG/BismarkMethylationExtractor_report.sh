...
## This script is for running bismark's methylation extract to get the
## non CpG methylation files. The output files can then be analyzed
## with the Bioconductor package bsseq.

## Contact informatino: andrew.jaffe@libd.org
